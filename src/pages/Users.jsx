...
const people = [
    ...
    {id:2, name: 'Lindsay Walton', phone_number: '+995 555 123 456', email: 'lindsay.walton@example.com', plan: 'Cheap', verified: false},
    {id:3, name: 'Lindsay Walton', phone_number: '+995 555 123 456', email: 'lindsay.walton@example.com', plan: 'Cheap', verified: false},
  ]
